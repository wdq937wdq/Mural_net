...
def get_params():
    params = {
        # 'weight': r'D:\yolo11_wdq\ultralytics-8.3.90\runs_final\seed=0\yolo11m\train2\weights\best.pt', # 现在只需要指定权重即可,不需要指定cfg ours
        # 'weight': r'D:\yolo11_wdq\ultralytics-8.3.90\runs_final\seed=42\SAAC+SER+MFFPN\train\weights\best.pt', # 现在只需要指定权重即可,不需要指定cfg ours
        'weight': r'D:\yolo11_wdq\ultralytics-8.3.90\runs_seed=1\yolo11n\train\weights\best.pt', # 现在只需要指定权重即可,不需要指定cfg   yolo11n
        'device': 'cuda:0',
        'method': 'XGradCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM, KPCA_CAM
        # 'layer': [17,19,22],  #ours
        'layer': [16,19,22],    #yolo11n
...
if __name__ == '__main__':
    ...
    model(r'D:\云大\小论文\可视化结果\检测图\images\001790.jpg', 'D:\云大\小论文\可视化结果\热力图\yolo11n')  #yolo11n
    # model(r'D:\云大\小论文\可视化结果\检测图\images\001790.jpg', 'D:\云大\小论文\可视化结果\热力图\ours')   #ours
